...
/**
 * Classe para animações, por exemplo, explosão.
 */

public class EfLeiser {
     ...
     */
    public EfLeiser(BufferedImage animImage, int frameWidth, int frameHeight,
    ...
    /**
     * Draws quadro atual da animação.
     *
     * @param g2d
     *            Graphics2D
     */
