...
public class Nave extends Framework {
     ...
     * Construtor da class.
     *
     * @param xCoordenada Starting x coordenada nave.
     * @param yCoordenada Starting y coordenda nave.
     */
     ...
     *
     * @param xCoordenada Starting x coordenada nave.
     * @param yCoordenada Starting y coordenada nave.
     */
    ...
    /**
     * @param moveVelocidadeY moveVelocidadeY set
     */
    ...
    /**
     * @param ajustaCoordenadaLeiserX the ajustaCoordenadaLeiserX to set
     */
    ...
    /**
     * @param ajustaCoordenadaLeiserY the ajustaCoordenadaLeiserY to set
     */
    ...
    /**
     * @param ajustaCoordenadaMissilX the ajustaCoordenadaMissilX to set
     */
    ...
    /**
     * @param ajustaCoordenadaMissilY the ajustaCoordenadaMissilY to set
     */
    ...
    /**
     * @param saudeAtual the saudeAtual to set
     */
    ...
    /**
     * @param BarraSaudeAtual the BarraSaudeAtual to set
     */
    ...
    /**
     * @param imgNave the imgNave to set
     */
    ...
    /**
     * @param coodernadaBarraSaudeHorizontal the coodernadaBarraSaudeHorizontal to set
     */
    ...
    /**
     * @param coodernadaBarraSaudeVertical the coodernadaBarraSaudeVertical to set
     */
